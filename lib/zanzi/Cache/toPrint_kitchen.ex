defmodule Zanzibloc.Cache.ToKitchen do
  use GenServer
  ...
  def handle_info(:print_to_dpt, state) do
    ...
    cond do
      isLive ->
        ...
        ZanziWeb.Endpoint.broadcast!("commande:kitchen", "printpaper", %{commande: toPrint_list})
  ...
  def amLive?(topic) do
    ...
    case presence_list["departement:kitchen"] do
      nil -> false
      _ -> true
    end
  end
