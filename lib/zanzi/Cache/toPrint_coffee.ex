defmodule Zanzibloc.Cache.ToCoffee do
  use GenServer
  ...
  def handle_info(:print_to_dpt, state) do
    ...
    cond do
      isLive ->
        ...
        ZanziWeb.Endpoint.broadcast!("commande:coffee", "printpaper", %{commande: toPrint_list})
  ...
  def amLive?(topic) do
    ...
    case presence_list["departement:coffee"] do
      nil -> false
      _ -> true
    end
  end
